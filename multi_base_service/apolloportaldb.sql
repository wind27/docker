...
VALUES
    ...
    ('organizations', '[{\"orgId\":\"auth\",\"orgName\":\"权限\"},{\"orgId\":\"platform\",\"orgName\":\"平台\"}]', '部门列表'),
...
#update ServerConfig set `Value` ='[{\"orgId\":\"auth\",\"orgName\":\"权限\"},{\"orgId\":\"platform\",\"orgName\":\"平台\"}]'  where `Key` = 'organizations';
